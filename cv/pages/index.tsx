    ...
    <>
      ...
      <div className="max-w-screen-lg mx-auto py-24 px-6">
        <header className="flex items-center space-x-12">
          <img
            src="/profile.png"
            className="w-52 rounded-lg bg-gray-600 object-contain object-bottom"
            alt=""
          />
          <div>
        ...
        <section className="flex items-start space-x-24 mt-8">
          <div className="flex-1">
            <h2 className="text-3xl font-medium">Projects</h2>

            <hr className="mt-4 opacity-25 border-dashed" />

            {PROJECTS.map((project) => (
              <div key={project.title} className="mt-8">
                <h3 className={`text-2xl text-${project.color} font-bold`}>
                  {project.title}
                </h3>
                <p className="max-w-md mt-2 text-lg">{project.description}</p>
              </div>
            ))}
            ...
            <div className="mt-10">
              ...
              <div className="mt-6">
                ...
                <p className="max-w-md mt-1 text-lg text-gray-400">
                  November 2019
                </p>
              </div>
              ...
              <div className="mt-6">
                ...
                <p className="max-w-md mt-1 text-lg text-gray-400">June 2018</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1">
            ...
            <div className="mt-8">
              ...
              <h4 className="mt-2 font-medium text-gray-400">
            ...
            <div className="mt-10">
              ...
              <div className="mt-6">
                <h3 className={`text-2xl font-bold`}>Wijkmanska Highschool</h3>
            ...
            <div className="mt-10">
              ...
              <p className="text-lg mt-6">
                ...
                PHP, HTML and CSS and learning the communication between server
                and client, and nowadays specializing in frameworks and tools
                like React, GraphQL, design-systems and state management
                libraries. I have knowledge with a large scale of web
